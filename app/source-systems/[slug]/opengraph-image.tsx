...
import { getSourceSystemBySlug } from "@/lib/content/sourceSystems";
...
export default async function Image({
  ...
  const name = system?.name ?? "Source System";
  const label = system?.label ?? "";
  const promise = system?.promise ?? "D365 Data Migration";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          {name} to Dynamics 365 Migration
        </div>
